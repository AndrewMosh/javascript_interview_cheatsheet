...
| 89  | [В чем разница между встроенными, хост объектамии объектами пользовательского кода ?](#в-чем-разница-между-встроенными-хост-объектамии-объектами-пользовательского-кода-)       |
...
## В чем разница между встроенными (native), хост-объектами (host) и объектами пользовательского кода (user) в JavaScript?
...
## Каковы плюсы и минусы использования промисов по сравнению с обратными вызовами?
